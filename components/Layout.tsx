...
import { 
  LayoutDashboard, ShoppingCart, Truck, Users, Settings, LogOut, Menu, X, Package, Activity, Bell, TrendingUp, DollarSign
} from 'lucide-react';
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-20 items-center justify-between bg-white/80 backdrop-blur-md px-6 lg:px-10 border-b border-stone-200/60 sticky top-0 z-20 shrink-0">
          ...
          <div className="flex items-center space-x-6">
            <button className="relative text-stone-400 hover:text-primary-600 transition-colors">
