      ...
      >
        <div className="flex h-20 items-center px-8 border-b border-stone-800/50 bg-stone-950/50 shrink-0">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white font-bold shadow-lg shadow-primary-500/30 text-[10px]">
              BM
            </div>
            <span className="text-xl font-bold tracking-tight text-white uppercase shrink-0">B.M. <span className="text-primary-400">Maruph</span></span>
          </div>
        </div>
