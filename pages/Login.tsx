...
import { AlertCircle, Mail, Lock, ArrowRight, User as UserIcon } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === 'LOGIN') {
        ...
        // Sign Up Mode
        // Defaulting new signups to CLERK per requirements.
      ...
      if (success) {
        ...
        // The Dashboard component handles showing/hiding content based on Admin vs Clerk role.
        navigate('/dashboard');
      } else {
        setError(mode === 'LOGIN' 
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white lg:bg-transparent">
        <div className="max-w-md w-full">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {error && (
              <div className="bg-red-50 text-red-600 p-4 rounded-xl text-sm flex items-center border border-red-100 animate-fadeIn">
